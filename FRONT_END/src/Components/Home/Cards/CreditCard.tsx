...
export default function CreditCard() {
    ...
    return (
        <div className="flex flex-col items-center justify-center ">
            <div className="relative  p-8 rounded-xl  w-[95%]">
                <div className="relative h-48 w-full  rounded-lg overflow-hidden bg-gradient-to-r from-dark-100 via-dark-200 to-dark-300 p-4">
            ...
            <motion.button 
                className="mt-8 bg-transparent border-2 border-orange-500 text-light-200 font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-orange-500 focus:outline-none w-full"
